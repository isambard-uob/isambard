...
from tools.geometry import angle_between_vectors, unit_vector, find_foot, Quaternion, dihedral,\
    find_transformations, cylindrical_to_cartesian, Axis
...
_backbone_properties = {
    ...
    'b_dna': {
        'mol_code_format': 'D{}',
        'labels': ["P", "OP1", "OP2", "O5'", "C5'", "C4'", "O4'", "C3'", "O3'", "C2'", "C1'"],
        'atoms': [
            (8.92, 0.0, 0.0),
            (10.23, 0.07, 0.21),
            (9.0, -0.14, 0.77),
...
_bases = {
    'G': {
        'labels': ["O4'", "C1'", "N9", "C8", "N7", "C5", "C6", "O6", "N1", "C2", "N2", "N3", "C4"],
        'ref_atom': "N9",
        'rot_adj': 15.0,
        'atoms': [
    ...
    'C': {
        'labels': ["O4'", "C1'", "N1", "C2", "O2", "N3", "C4", "N4", "C5", "C6"],
        'ref_atom': "N1",
        'rot_adj': 47.0,
        'atoms': [
    ...
    'A': {
        'labels': ["O4'", "C1'", "N9", "C8", "N7", "C5", "C6", "N6", "N1", "C2", "N3", "C4"],
        'ref_atom': "N9",
        'rot_adj': 5.0,
        'atoms': [
            (39.099, 26.091,  9.763),
    ...
    'T': {
        'labels': ["O4'", "C1'", "N1", "C2", "O2", "N3", "C4", "O4", "C5", "C7", "C6"],
        'ref_atom': "N1",
        'rot_adj': 30.0,
        'atoms': [
            (43.43,  23.953,  9.349),
...
class NucleicAcidStrand(Polynucleotide):
    ...
    def rotate(self, angle, axis, point=None, radians=False):
        super(Polynucleotide, self).rotate(angle=angle, axis=axis, point=point, radians=radians)
    ...
    def build(self):
        ...
        for i, b in enumerate(self.base_sequence):
            ...
            translation, angle, axis, point = find_transformations(
                base_dict[base_ref], base_dict["C1'"], atoms_dict[base_ref]._vector, atoms_dict["C1'"]._vector)
            ...
            for k, v in list(base_dict.items()):
                if k not in atoms_dict:
                    atom = Atom(q2.rotate_vector(v, base_dict[base_ref]), element=k[0], ampal_parent=nucleotide,
                                res_label=k)
                    atoms_dict[k] = atom
